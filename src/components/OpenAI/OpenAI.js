...
function OpenAI() {
  return (
    <section className="openai" id="openai">
        <div className="openai--container">
          ...
          <div className='col-2'>
            <div className='feature'>
              <h3 className='bar-gradient'>Improving end distrusts instantly</h3>
            ...
            <div className='feature'>
              <h3 className='bar-gradient'>Become the tended active</h3>
